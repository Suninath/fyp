...
const TabsList = ({ className, children, activeTab, setActiveTab, ...props }) => (
  <div
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gray-100 p-1.5 text-gray-600 border border-gray-200",
      className
    )}
    {...props}
  >
...
const TabsTrigger = ({ className, children, value, activeTab, setActiveTab, ...props }) => (
  <button
