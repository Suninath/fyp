  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-full p-1.5 bg-gray-100 hover:bg-gray-200 opacity-70 transition-all hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:pointer-events-none z-10">
...
const DialogFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse sm:flex-row sm:justify-end gap-3 p-6 pt-4 bg-gray-50/50 border-t border-gray-100", className)}
    {...props} />
)
